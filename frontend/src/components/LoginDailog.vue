                ...
                <DialogContent
                    ...
                    <form class="flex flex-col items-center" @submit.prevent="handleLogin">
                        ...
                        <div class="form-control w-full max-w-xs mt-7">
                            ...
                            <input v-model="memberName" required type="text" placeholder="Type here" maxlength=""
                        ...
                        <div class="form-control w-full max-w-xs mt-4">
                            ...
                            <input v-model="password" required type="password" placeholder="Type here" maxlength=""
                                class="input border-gray-500 border-2 w-full max-w-xs" />
                            <label class="label">
                            </label>
                        </div>
